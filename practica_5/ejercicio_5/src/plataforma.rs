...
pub fn test_plataforma_mayor_suscripcion_activa() {
    ...
    let sub_basic = Some(SubscriptionInfo::new(SubscriptionType::Basic, 7.99, 1, Fecha::new(5, 6, 2025)));
    let sub_clasic = Some(SubscriptionInfo::new(SubscriptionType::Clasic, 10.99, 3, Fecha::new(20, 4, 2025)));
    let sub_super = Some(SubscriptionInfo::new(SubscriptionType::Super, 13.99, 1, Fecha::new(15, 6, 2025)));
    let inactiva = Some(SubscriptionInfo::new(SubscriptionType::Clasic, 7.99, 1, Fecha::new(1, 5, 2025)));
...
pub fn test_plataforma_mayor_suscripcion() {
    ...
    let sub_basic = Some(SubscriptionInfo::new(SubscriptionType::Basic, 7.99, 1, Fecha::new(5, 6, 2024)));
    let sub_clasic = Some(SubscriptionInfo::new(SubscriptionType::Clasic, 10.99, 3, Fecha::new(20, 4, 2025)));
    let sub_super = Some(SubscriptionInfo::new(SubscriptionType::Super, 13.99, 1, Fecha::new(15, 6, 2025)));
    let inactiva = Some(SubscriptionInfo::new(SubscriptionType::Clasic, 7.99, 1, Fecha::new(1, 5, 2025)));
    plataforma.crear_usuario(1, sub_basic.clone(), MedioDePago::TarjetaCredito);
...
pub fn test_plataforma_mayor_metodo_activo() {
    ...
    let plataforma2 = Plataforma::new();
    assert_eq!(None, plataforma2.mayor_metodo_activo());
}
